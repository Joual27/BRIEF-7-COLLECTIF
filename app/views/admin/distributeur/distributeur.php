      ...
      <div class="relative overflow-x-auto shadow-md  ml-[185px] top-12 sm:rounded-lg">
        ...
        <table class="w-full text-lg text-left rtl:text-right mt-5 text-gray-500 dark:text-gray-400">
            ...
            <?php foreach ($distributeurs as $distributeur): ?>
                <tr>
                    <td class="px-6 py-4"><?= $distributeur['atmID']; ?></td>
                    ...
                    <td class="px-6 py-4">
                        <a href="editDistributeur.php?id=<?= $distributeur['atmID']; ?>" class="text-blue-500 hover:text-blue-700">Edit</a>
                        <a href="deleteDistributeur.php?id=<?= $distributeur['atmID']; ?>" class="text-red-500 hover:text-red-700" >Delete</a>                    
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
