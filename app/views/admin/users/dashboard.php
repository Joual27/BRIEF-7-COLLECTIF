...
//   include '../../incfile/permissionsOfUser.php';
  include($_SERVER["DOCUMENT_ROOT"]."/bank-app/app/views/incfile/persmissionsOfUser.php");
...
?>
   ...
   <!-- TABLE -->
     ...
     if($permissions == "permissions_of_sub_admin"){
         echo "
